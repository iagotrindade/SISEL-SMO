...
{
    erro($BASE_URL, 3, 98898918, $pagina_atual, "prioridade_nao_cadastrada", "Não foi possível cadastrar o prioridade!");
    exit();
}
...
header ("Location: ../obrigatorio.php?crip=$crip_url&id_obrigatorio=$id_obrigatorio&aba=1#prioridades");
