...
class Obrigatorio
{
    ...
    /**
     * Converte o objeto em array associativo para comparação de mudanças (diff)
     */
    public function toArray()
    {
        return [
            ...
            'forca' => $this->forca,
            'nome_instituicao_ensino' => $this->nome_instituicao_ensino,
            'ano_formacao' => $this->ano_formacao,
            'formacao' => $this->formacao,
            'ano_residencia_espe_1' => $this->ano_residencia_espe_1,
            'ano_residencia_espe_2' => $this->ano_residencia_espe_2,
            'ano_residencia_espe_3' => $this->ano_residencia_espe_3,
            'cidade_instituicao_ensino' => $this->cidade_instituicao_ensino,
            'jise' => $this->jise,
            'cid_jise' => $this->cid_jise,
            'data_exame_medico' => $this->data_exame_medico,
            'observacao_jise' => $this->observacao_jise,
            'jisr' => $this->jisr,
            'cid_jisr' => $this->cid_jisr,
            'data_jisr' => $this->data_jisr,
            'jise_a_1' => $this->jise_a_1,
            'cid_jise_a_1' => $this->cid_jise_a_1,
            'data_jise_a_1' => $this->data_jise_a_1,
            'observacao_jise_a_1' => $this->observacao_jise_a_1,
            'data_selecao_geral' => $this->data_selecao_geral,
            'data_comparecimento_selecao_geral' => $this->data_comparecimento_selecao_geral,
            'data_comparecimento_designacao' => $this->data_comparecimento_designacao,
            'data_proxima_apresentacao' => $this->data_proxima_apresentacao,
            'situacao_militar' => $this->situacao_militar,
            'solicitou_adiamento' => $this->solicitou_adiamento,
            'inicio_adiamento' => $this->inicio_adiamento,
            'fim_adiamento' => $this->fim_adiamento,
            'especialidade_adiamento' => $this->especialidade_adiamento,
            'transferencia_fisemi' => $this->transferencia_fisemi,
            'rm_origem_fisemi' => $this->rm_origem_fisemi,
            'rm_destino_fisemi' => $this->rm_destino_fisemi,
            'numero_acao' => $this->numero_acao,
            'transitou_julgado' => $this->transitou_julgado,
            'data_liminar' => $this->data_liminar,
            'favoravel' => $this->favoravel,
            'convocado' => $this->convocado,
            'distribuicao' => $this->distribuicao,
            'om_1_fase' => ($this->om_1_fase instanceof OM) ? $this->om_1_fase->getAbreviatura() : $this->om_1_fase,
            'compareceu_designacao' => $this->compareceu_designacao,
            'local_compareceu_designacao' => $this->local_compareceu_designacao,
            'data_selecao_complementar' => $this->data_selecao_complementar,
            'resultado_revisao_medica_complementar' => $this->resultado_revisao_medica_complementar,
            'resultado_isgr' => $this->resultado_isgr,
            'data_incorporacao' => $this->data_incorporacao,
            'om_2_fase' => $this->om_2_fase,
            'observacao' => $this->observacao,
            'especialidade_1' => $this->especialidade_1,
            'especialidade_2' => $this->especialidade_2,
            'especialidade_3' => $this->especialidade_3,
            'data_revisao_medica' => $this->data_revisao_medica,
            'cid_revisao_medica' => $this->cid_revisao_medica,
            'obs_revisao_medica' => $this->obs_revisao_medica,
            'incorporacao' => $this->incorporacao,
            'bar_om_1_fase' => $this->bar_om_1_fase,
            'data_isgr' => $this->data_isgr,
            'cid_isgr' => $this->cid_isgr,
            'observacao_isgr' => $this->observacao_isgr,
        ];
    }
