...
if($crip != hash('sha256', $_SESSION['chave']. "obrigatorio"))
    erro($BASE_URL, 2, 777895, $pagina_atual, "criptografia_invalida", "Não foi possível editar o usuário!");
...
header ("Location: ../obrigatorio.php?crip=$crip_url&id_obrigatorio=$id_obrigatorio_edita&aba=10");
